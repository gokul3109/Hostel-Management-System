...
document.getElementById("book_link").addEventListener("click", () => {
...
document.getElementById("swap_link").addEventListener("click", () => {
    book.classList.remove("active")
    swap.classList.add("active")
    vacate.classList.remove("active")
    HosAv.classList.remove("active")
})
document.getElementById("vacate_link").addEventListener("click", () => {
    book.classList.remove("active")
    swap.classList.remove("active")
    vacate.classList.add("active")
    HosAv.classList.remove("active")
})
document.getElementById("hosav_link").addEventListener("click", () => {
    book.classList.remove("active")
    swap.classList.remove("active")
    vacate.classList.remove("active")
